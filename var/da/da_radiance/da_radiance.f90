...
!      mpi_2double_precision
   ...
   use da_control, only : max_ob_levels,missing_r, &
      ...
      use_mwtsobs, use_mwts2cobs, use_mwts2dobs, use_mwts3eobs, use_mwhsobs, &
      use_mwhs2cobs, use_mwhs2dobs, use_mwhs2eobs, use_atmsobs, use_amsr2obs, use_ahiobs,use_gmiobs, &
   ...
   use da_radiance1, only : num_tovs_before,num_tovs_after,tovs_copy_count, &
      ...
      da_qc_rad, da_cld_eff_radius, da_read_biascoef, da_qc_mwhs2c, &
      da_qc_mwhs2d, da_qc_mwhs2e, da_qc_mwts2c, da_qc_mwts2d, da_qc_mwts3e
...
#include "da_read_obs_hdf5mwhs2c.inc"
#include "da_read_obs_hdf5mwhs2d.inc"
#include "da_read_obs_hdf5mwhs2e.inc"  
#include "da_read_obs_hdf5mwts2c.inc"
#include "da_read_obs_hdf5mwts2d.inc"
#include "da_read_obs_hdf5mwts3e.inc"
